    ...
    <div class="">
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-body">
                    <form method="POST" action="{{route('sanpham.update',['id'=>$sanphams->idsanpham])}}">
                        @csrf
                        <div class="form-group">
                            ...
                            <input type="text" name="tensanpham" id="" class="form-control" value="{{ $sanphams->tensanpham }}">
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Màu sắc</label>
                                    <input type="text" name="mausac" id="" class="form-control" value="{{ $sanphams->mausac }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="kichco" id="" class="form-control" value="{{ $sanphams->kichco }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Ảnh</label>
                                    <input type="file" name="img" id="" class="form-control" value="{{ $sanphams->img }}">
                                    @if($sanphams->img)
                                    <img src="{{ asset('imgapple/' . $sanphams->img) }}" alt="Ảnh sản phẩm" width="100">
                                    @endif
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="idLoai" class="form-control">
                                        ...
                                        <option value="{{ $loai->idLoai }}" {{ $sanphams->idLoai == $loai->idLoai ? 'selected' : '' }}>{{ $loai->tenloai }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="soluongton" id="" class="form-control" value="{{ $sanphams->soluongton }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="mota" id="" class="form-control" value="{{ $sanphams->mota }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="capnhat" class="form-control" value="{{ $sanphams->capnhat }}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="giatien" id="" class="form-control" value="{{ $sanphams->giatien }}">
                                </div>
                            </div>
                        </div>
